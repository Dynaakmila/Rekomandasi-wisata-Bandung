...
"""pada wisata.info terdapat data yang tidak diperlukan terdapat pada baris ke 11 dan 12, jadi kita hapus saja"""
...
Separti yang sudah dijelaskan kita akan membuat rekomendasi dari 1 kota saja, saya memiih kota bandung.

Jadi akan menampilkan rekomendasi wisata dikota Bandung aja.
"""

wisata_bandung = wisata[wisata['City']=='Bandung']
wisata_bandung

"""Sekarang kita akan menampilkan rating dari destinasi wisata yang ada di Bandung"""

rating_wisata_bandung = pd.merge(rating_wisata, wisata_bandung[['Place_Id']], how='right', on='Place_Id')
rating_wisata_bandung

"""Selanjutnya kita akan menampilkan hanya pengunjung yang memberi rating wisata di Bandung"""
...
"""Wisata dengan kategori terbanyak"""
...
"""mempersiapkan data untuk sistem rekomendasi berbasis konten (content-based filtering)."""
